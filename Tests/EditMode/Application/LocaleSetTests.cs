...
namespace PromptUGUI.Tests.Application
{
    public class LocaleSetTests
    {
        ...
        [Test]
        public void Initial_CurrentIsNull()
        {
            Assert.IsNull(UI.Locale.Current);
        }

        [Test]
        public void Set_UpdatesCurrent_FiresChanged()
        {
            var n = 0;
            UI.Locale.Changed += () => n++;
            UI.Locale.Set("en");
        ...
        [Test]
        public void Set_SameValueTwice_DoesNotFire()
        {
            var n = 0;
            UI.Locale.Set("en");
            UI.Locale.Changed += () => n++;
        ...
        [Test]
        public void Set_TogglesVariantNamedAfterLocale()
        {
        ...
        [Test]
        public void Set_Null_ClearsVariantAndCurrent()
        {
            UI.Locale.Set("en");
            UI.Locale.Set(null);
            Assert.IsNull(UI.Locale.Current);
        ...
        [Test]
        public void Set_TriggersVariantChanged()
        {
            var n = 0;
        ...
        [Test]
        public void Tr_StaticMethod_DelegatesToTrResolver()
        {
