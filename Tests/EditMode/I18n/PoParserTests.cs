...
namespace PromptUGUI.Tests.I18n
{
    ...
    {
        [Test]
        public void Parse_SingleEntry_ReturnsMsgidMsgstr()
        {
            var src = "msgid \"hello\"\nmsgstr \"你好\"\n";
        ...
        [Test]
        public void Parse_WithMsgctxt_PopulatesCtx()
        {
        ...
        [Test]
        public void Parse_MultilineString_ConcatenatesQuoted()
        {
            var src = "msgid \"\"\n\"line1 \"\n\"line2\"\nmsgstr \"\"\n\"out\"\n";
            var e = PoParser.Parse(src).Single();
        ...
        [Test]
        public void Parse_EscapeSequences_AreDecoded()
        {
            var src = "msgid \"a\\nb\\tc\\\"d\\\\e\"\nmsgstr \"\"\n";
            var e = PoParser.Parse(src).Single();
            Assert.AreEqual("a\nb\tc\"d\\e", e.Msgid);
        ...
        [Test]
        public void Parse_TranslatorCommentsCollected()
        {
        ...
        [Test]
        public void Parse_ObsoleteEntries_AreSkipped()
        {
            var src = "#~ msgid \"old\"\n#~ msgstr \"old-tr\"\nmsgid \"new\"\nmsgstr \"new-tr\"\n";
            var entries = PoParser.Parse(src).ToList();
            Assert.AreEqual(1, entries.Count);
        ...
        [Test]
        public void Parse_HeaderEntry_IsReturnedLikeOthers()
        {
        ...
        [Test]
        public void Parse_MissingMsgstr_Throws()
        {
            Assert.Throws<PoParseException>(() => PoParser.Parse("msgid \"x\"\n").ToList());
        }

        [Test]
        public void Roundtrip_BasicEntries_PreservesContent()
        {
            var src = new[] {
        ...
        [Test]
        public void Serialize_EscapesNewlinesAndQuotes()
        {
            var entries = new[] {
