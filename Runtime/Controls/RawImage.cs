    ...
    public sealed class RawImage : Control, IPointerEventSource
    {
        ...
        public string Color
        {
            set
            {
                ...
                if (spec.IsGradient) Internal.RotateFlipApplier.ReserveSlot(_raw);
        ...
        {
            get => _rotation;
            set { _rotation = value; Internal.RotateFlipApplier.Apply(_raw, _rotation, _flip); }
        }
        ...
        {
            get => _flip;
            set { _flip = value; Internal.RotateFlipApplier.Apply(_raw, _rotation, _flip); }
        }
