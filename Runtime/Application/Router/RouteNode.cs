...
namespace PromptUGUI.Application
{
    ...
    /// <summary>
    /// How a navigation sequences the outgoing page's exit animation against the incoming
    /// page (spec 2026-09-16-close-transition §5.5). Only matters for pages that declare an
    /// exit (<c>on="close"</c> / <c>reverse-on="close"</c>); the rest are destroyed at once.
    /// </summary>
