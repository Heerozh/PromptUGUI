...
namespace PromptUGUI.Editor
{
    internal sealed class UIAssetPostprocessor : AssetPostprocessor
    {
            ...
            string[] movedFromAssetPaths)
        {
            ...
            if (current != null)
            {
                var poChanged = importedAssets.Concat(movedAssets).Concat(deletedAssets)
            ...
            var settingsChanged = importedAssets
        ...
        private static bool IsForLocale(string assetPath, string locale)
        {
